...
{
    public class GLBALANCE_ACTUAL_TEMPMap : EntityTypeConfiguration<GLBALANCE_ACTUAL_TEMP>
    {
        public GLBALANCE_ACTUAL_TEMPMap()
        {
            // Primary Key
            ...
            this.ToTable("GLBALANCE_ACTUAL_TEMP", "EPM_ODS");
