...
{
    public class SALEDETAIL_ACTUAL_TEMPMap : EntityTypeConfiguration<SALEDETAIL_ACTUAL_TEMP>
    {
        public SALEDETAIL_ACTUAL_TEMPMap()
        {
            // Primary Key
            ...
            this.ToTable("SALEDETAIL_ACTUAL_TEMP", "EPM_ODS");
