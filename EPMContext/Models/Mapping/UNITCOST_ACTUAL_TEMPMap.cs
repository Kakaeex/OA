...
{
    public class UNITCOST_ACTUAL_TEMPMap : EntityTypeConfiguration<UNITCOST_ACTUAL_TEMP>
    {
        public UNITCOST_ACTUAL_TEMPMap()
        {
            // Primary Key
            ...
            this.ToTable("UNITCOST_ACTUAL_TEMP", "EPM_ODS");
