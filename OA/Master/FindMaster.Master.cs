...
namespace OA.Master
{
    public partial class FindMaster : System.Web.UI.MasterPage
    {
        ...
        protected void New_Click(object sender, EventArgs e)
        {
            ...
            {
                string[] url = Page.GetNewUrl().ToString().Split(',');
                PageContext.RegisterStartupScript(string.Format("AddActiveTab('{0}','{1}');", url[0], url[1]));
            }
        }
        ...
        protected void Select_Click(object sender, EventArgs e)
        {
            ...
            {
                string[] url = Page.GetEditUrl().ToString().Split(',');
                PageContext.RegisterStartupScript(string.Format("AddActiveTab('{0}','{1}');", url[0], url[1]));
            }
        }
