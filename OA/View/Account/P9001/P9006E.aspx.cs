...
namespace OA.View.Account.P9001
{
    public partial class P9006E : PagedBase, IEditPage
    {
        ...
        {
            Master.bind<C_F9006, int>(null, p => p.RAAN8);
        }
        ...
        public dynamic GetGridRowData(Dictionary<string, object> rowDict = null, object[] values = null, int deletedRows = 0)
        {
            ...
            {
                #region 新增
                obj.RAKCOO = rowDict["RAKCOO"].ToString();
                obj.RAAN8 = ValueConvert.toInt(rowDict["RAAN8"]);
                obj.RAID = rowDict["RAID"].ToString();
                obj.RADEL1 = rowDict["RADEL1"].ToString();
            ...
            else if (values != null)
            {
                ...
                obj.RAAN8 = ValueConvert.toInt(values[1]);
                obj.RAID = values[2].ToString();
                obj.RADEL1 = values[3].ToString();
                obj.RADEL2 = values[4].ToString();
                obj.RASRP1 = values[5].ToString();
                obj.RASRP2 = values[6].ToString();
                obj.RASRP3 = values[7].ToString();
                obj.RASRP4 = values[8].ToString();
                obj.RASRP5 = values[9].ToString();
                obj.RAPRP1 = ValueConvert.toInt(values[10]);
                obj.RAPRP2 = ValueConvert.toInt(values[11]);
                obj.RAPRP3 = ValueConvert.toInt(values[12]);
                obj.RAPRP4 = ValueConvert.toInt(values[13]);
                obj.RAPRP5 = ValueConvert.toInt(values[14]);
                obj.RAUSER = Master.userID;
                obj.RAPID = Master.progammeID;
                obj.RADATE = Master.now;
                obj.RATIME = Master.time;
            ...
            else if (deletedRows > 0)
            {
                ...
                obj = Master._DBHelper.Find<C_F9006>(p => p.RAKCOO == "" & p.RAAN8 == 0 & p.RAID == "");
                return obj;
                #endregion
            }
            else
