<%@ Page Title="" Language="C#" MasterPageFile="~/Master/EditMaster.Master" AutoEventWireup="true" CodeBehind="P9008EA.aspx.cs" Inherits="OA.View.Account.Users.P9008EA" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="findMainMaster" runat="server">
    <f:Panel ID="mainPanel" runat="server" BodyPadding="3px" ShowBorder="True" ShowHeader="false"
        ...
        <Items>
            <f:Form ID="FORM1" runat="server" ShowBorder="True" BodyPadding="5px" ShowHeader="false" Title="表单">
                <Rows>
                    <f:FormRow>
                        <Items>
                            <f:TriggerBox ID="FHDOCO" EnableEdit="false" Width="300px" Label="费用项目号"
                                TriggerIcon="Search" runat="server">
                            </f:TriggerBox>
                            <f:Label ID="DSC1" runat="server"></f:Label>
                        </Items>
                    </f:FormRow>
                </Rows>
            </f:Form>
        ...
        <Items>
            <f:Grid ID="Grid1" runat="server" ShowHeader="false" DataKeyNames="AUAN8" AllowCellEditing="true" ClicksToEdit="1" EnableMultiSelect="false" EnableCheckBoxSelect="false"
                ...
                <Columns>
                    ...
                    <f:RenderField Width="100px" DataField="AUDEL1" ColumnID="AUDEL1" FieldType="String"
                        HeaderText="备注1">
                        <Editor>
                            <f:TextBox ID="AUDEL1" Readonly="true" runat="server">
                            </f:TextBox>
                        </Editor>
                    </f:RenderField>
                    <f:RenderField Width="100px" DataField="AUDEL2" ColumnID="AUDEL2" FieldType="String"
                        HeaderText="备注2">
                        <Editor>
                            <f:TextBox ID="AUDEL2" Readonly="true" runat="server">
                            </f:TextBox>
                        </Editor>
                    </f:RenderField>
                    <f:RenderField Width="100px" DataField="AUSRP1" ColumnID="AUSRP1" FieldType="String"
                        ...
                        <Editor>
                            <f:TextBox ID="AUSRP1" Readonly="true" runat="server">
                            </f:TextBox>
                        </Editor>
                    </f:RenderField>
